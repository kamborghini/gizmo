...
(function () {
    ...
    var CSS = [
        ...
        '    padding: var(--sp-1); border: 1px solid var(--border-default); border-bottom: 0;',
        '    border-radius: var(--radius-sm) var(--radius-sm) 0 0; background: var(--surface-tertiary); position: relative; }',
        '.cmp-b { border: 1px solid transparent; background: transparent; color: var(--text-primary);',
        ...
        '.cmp-b:focus-visible { outline: none; box-shadow: var(--focus-ring); }',
        ...
        '    padding: var(--sp-2); background: var(--surface-primary); border: 1px solid var(--border-default);',
        '    border-radius: var(--radius-sm); box-shadow: var(--shadow-lg); }',
        '.cmp-sw { width: 28px; height: 28px; border-radius: var(--radius-xs); border: 1px solid var(--border-strong);',
        '    cursor: pointer; padding: 0; }',
        '.cmp-sw.none { background: var(--surface-primary); color: var(--text-tertiary); font-size: var(--text-xs); }',
        ...
        '.cmp-area:focus { outline: none; border-color: var(--action-primary); box-shadow: var(--focus-ring); }',
        '.cmp-area.cmp-empty:before { content: attr(data-ph); color: var(--text-tertiary); }',
        ...
        '    border-left: 2px solid var(--border-strong); color: var(--text-secondary); }',
        '.cmp-area img { max-width: 100%; height: auto; border-radius: var(--radius-xs); }',
        '.cmp-area a { color: var(--action-primary); }',
        ...
        '.cmp-chip-s { color: var(--text-tertiary); }',
        '.cmp-x { border: 0; background: transparent; color: var(--text-tertiary); cursor: pointer;',
        ...
        '.cmp-meter { color: var(--text-tertiary); font-size: var(--text-xs); margin-top: var(--sp-1); }',
        '.cmp-note { color: var(--error); font-size: var(--text-xs); margin-top: var(--sp-1); }',
